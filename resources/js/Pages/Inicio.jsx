            ...
            <div className="Atma inicio_portada">
                <div className={"inicio_content"}>
                    <Container className="inicio_title">
                        ...
                        >
                            Somos Cantera Lúdica: donde jugar lo es todo. Juegos
                            de mesa, talleres y eventos lúdicos.
                        </Grid>
                        <a href="#tienda" className="inicio_button">
                            Tienda{" "}
                            <ArrowRightAltIcon
                                style={{ marginLeft: 13, fontSize: 35 }}
                            ></ArrowRightAltIcon>
                        </a>
                    </Container>
                    {/* <Container> 
...
Inicio.layout = (page) => (
    <Layout children={page} title="Comepasto - Inicio" pageTitle="Inicio" />
);
