...
import horizontal from "../../../../public/images/logos/horizontal.png";
        ...
        <div>
            ...
            >
                <div className="navbar-sup">
                    <div className="div-redes">
                        <a
                            className="icono"
                            href="http://facebook.com/comepastov"
                            target="_blank"
                        >
                            <img
                    ...
                    <div className="div-logo">
                        <InertiaLink href={route("inicio")}>
                            <Grid container justifyContent="center">
                                <img src={horizontal} width={180} />
                            </Grid>
                        </InertiaLink>
                    </div>
                    <div className="links-hide">
                        <InertiaLink href={route("inicio")}>TIENDA</InertiaLink>
            ...
            <Slide in={NavDialog} direction="down" mountOnEnter unmountOnExit>
                <nav className="navigation">
                    <ul>
                        ...
                        {!auth.user ? (
                            <li>
                                <a onClick={handleOpenLogin}>INICIAR SESIÓN</a>
                            </li>
                        ) : (
                            <>
                                <li>
            ...
            >
                <form onSubmit={handleSubmit}>
                    ...
                    <Grid
                        container
                        style={{ backgroundColor: "#313131", padding: 10 }}
                    >
                        <DialogContentText
                            style={{
                                fontFamily: "Oxygen",
                        ...
                        >
                            Busca tu producto favorito en Cantera Lúdica.
                        </DialogContentText>
                    </Grid>
                    <DialogContent>
